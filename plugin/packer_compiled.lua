...
_G.packer_plugins = {
  ...
  ["carbon-now.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/carbon-now.nvim",
  ...
  ["monark.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/monark.nvim",
  ...
  ["onedarkpro.nvim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
